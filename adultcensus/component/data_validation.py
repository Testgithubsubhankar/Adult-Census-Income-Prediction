...
from adultcensus.entity.config_entity import DataValidationConfig
from adultcensus.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
import os,sys
import pandas as pd
