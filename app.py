...
import pip
from adultcensus.util.util import read_yaml_file, write_yaml_file
...
from adultcensus.constant import CONFIG_DIR, get_current_time_stamp
from adultcensus.pipeline.pipeline import Pipeline
from adultcensus.entity.adultcensus_predictor import AdultCensusPredictor,AdultcensusData
from flask import send_file, abort, render_template


ROOT_DIR = os.getcwd()
LOG_FOLDER_NAME = "logs"
PIPELINE_FOLDER_NAME = "adultcensus"
...
from adultcensus.logger import get_log_dataframe

ADULTCENSUS_DATA_KEY = "adultcensus_data"
ADULTCENSUS_INCOME_PREDICTION_KEY = "adultcensus_income_prediction"

app = Flask(__name__)


@app.route('/artifact', defaults={'req_path': 'adultcensus'})
@app.route('/artifact/<path:req_path>')
def render_artifact_dir(req_path):
    os.makedirs("adultcensus", exist_ok=True)
...
def predict():
    context = {
        ADULTCENSUS_DATA_KEY : None,
        ADULTCENSUS_INCOME_PREDICTION_KEY : None
    }
